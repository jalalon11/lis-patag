<template>
  <AdminLayout page-title="Edit Section">
    <div class="container-fluid py-3">
      ...
      <div class="row mb-4">
        <div class="col-md-8">
          ...
          <p class="text-muted mb-0">Update section information for {{ section.grade_level }} - {{ section.section_name }}</p>
        </div>
...
export default {
  ...
  methods: {
    submit() {
      ...
      this.form.put(`/admin/sections/${this.section.id}`, {
        onSuccess: () => {
          showSuccessToast('Section Updated!', `${sectionName} has been updated successfully.`)
