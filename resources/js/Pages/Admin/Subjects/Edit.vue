<template>
  <AdminLayout page-title="Edit Subject">
...
export default {
  ...
  data() {
    return {
      ...
      form: useForm({
        ...
        grade_levels: this.subject.grade_levels || [],
        units: this.subject.units,
  ...
  methods: {
    submit() {
      this.form.put(`/admin/subjects/${this.subject.id}`, {
        onSuccess: () => {
          showSuccessToast('Subject Updated!', `${this.form.subject_name} has been updated successfully.`)
